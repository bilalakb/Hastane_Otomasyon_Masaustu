...
public class HastaGUI extends JFrame {
	...
	public HastaGUI(Hasta hasta) throws SQLException {
		...
		lblNewLabel.setBounds(249, 10, 254, 41);
		...
		lblNewLabel_1_4.setBounds(300, 29, 97, 23);
		w_appointment.add(lblNewLabel_1_4);
		
		JComboBox select_clinic = new JComboBox();
		select_clinic.setBounds(300, 62, 150, 35);
		...
		btn_SelDoctor.setBackground(Color.BLUE);
		...
		btn_SelDoctor.setBounds(300, 107, 150, 32);
		...
		lblNewLabel_1_1.setBounds(460, 7, 241, 23);
		w_appointment.add(lblNewLabel_1_1);
		
		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(460, 29, 241, 299);
		w_appointment.add(w_scrollWhour);
		
		table_whour = new JTable(whourModel);
		table_whour.setFont(new Font("Tahoma", Font.BOLD, 10));
		w_scrollWhour.setViewportView(table_whour);
		
		JButton btn_addAppoint = new JButton("Randevu Al");
		btn_addAppoint.setBackground(Color.BLUE);
